...
function getPkmnName(rl) {
    return new Promise(function (resolve) {
        rl.question("[PokeDex]: Hi Ash, Please enter the name of a pokemon: ", function (pkmnName) {
            ...
            console.log("[PokeDex]: Searching for ".concat(pkmnName));
            resolve(pkmnName);
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 5, , 6]);
                    return [4 /*yield*/, getPkmnName(rl)];
                case 2:
                    pkmnName = _a.sent();
                    return [4 /*yield*/, (0, pokedexController_1.retrievePkmnData)(pkmnName)];
                case 3:
                    pkmnData = _a.sent();
                    if (!pkmnData) {
                        rl.close();
                    ...
                    return [4 /*yield*/, (0, pokedexController_1.retrievePkmnEvolutionData)(pkmnData.data.evolution_chain.url, pkmnName)];
                case 4:
